...
import { TaskDTO, TaskFilters, TaskPageResponse } from '@/types/task';
...
async function claimTask(taskId: string): Promise<void> {
  await apiClient.post(`/api/tasks/${taskId}/claim`, {});
}

async function completeTask(taskId: string, variables: Record<string, any> = {}): Promise<void> {
  await apiClient.post(`/api/tasks/${taskId}/complete`, { variables });
}

async function delegateTask(taskId: string, delegateTo: string): Promise<void> {
  await apiClient.post(`/api/tasks/${taskId}/delegate`, { delegateTo });
}
